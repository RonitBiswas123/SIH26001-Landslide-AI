...
st.markdown(
    ...
    .stApp {
        background:
            radial-gradient(circle at 85% 0%, rgba(14,165,233,.08), transparent 28%),
    ...
    .badge.online { border-color: #bbf7d0; background: #f0fdf4; color: #166534; }
    .badge.proto { border-color: #fde68a; background: #fffbeb; color: #92400e; }
    ...
    .hero h3 { margin: 0 0 4px 0; color: #0f172a; }
    ...
    /* ---------- Risk boxes ---------- */
    .critical-box, .high-box, .moderate-box, .low-box {
        padding: 18px 20px;
        border-radius: 15px;
        margin-bottom: 15px;
        box-shadow: 0 5px 18px rgba(15,23,42,.05);
    }
    .critical-box { background:#fff1f2; border:1px solid #fecdd3; border-left:7px solid #dc2626; }
    .high-box { background:#fff7ed; border:1px solid #fed7aa; border-left:7px solid #f97316; }
    .moderate-box { background:#fffbeb; border:1px solid #fde68a; border-left:7px solid #eab308; }
    .low-box { background:#f0fdf4; border:1px solid #bbf7d0; border-left:7px solid #16a34a; }
